                ...
                <ul>
                  ...
                  <Tab>
                    <img
                      ...
                      alt="avatar"
                    />
                    <span className="menu_content">Nosotros</span>
                  </Tab>
                  <Tab>
                    <img
                      className="svg"
                      ...
                      alt="avatar"
                    />
                    <span className="menu_content">Servicios</span>
                  </Tab>
                  <Tab>
                    <img
                      className="svg"
                  ...
                  <Tab>
                    <img
                      ...
                      alt="mail"
                    />
                    <span className="menu_content"> Contacto</span>
                  </Tab>
                </ul>
              </div>
              {/* END MENU */}
